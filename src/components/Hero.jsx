...
export default function Hero() {
  ...
  const c = heroDark
    ? {
        section: "bg-[#050705]", blob1: "bg-[#132015]", blob2: "bg-[#16241a]", wave: "text-[#0c130d]",
        badgeBg: "bg-[#111812]/80", badgeText: "text-[#f8fafc]", badgeBorder: "border-[#1f2b21]",
        heading: "text-[#f8fafc]", accent: "text-[#84cc16]", subText: "text-[#94a3b8]",
        btnPrimary: "bg-[#84cc16] text-black hover:bg-[#65a30d]",
        btnOutline: "bg-[#111812] text-[#f8fafc] border-[#1f2b21] hover:bg-[#161f17]",
        socialBg: "bg-[#111812]", socialBorder: "border-[#1f2b21]", socialText: "text-[#f8fafc]",
        socialHover: "hover:border-[#84cc16] hover:text-[#84cc16]", handDrawn: "text-[#cbd5e1]",
        arrow: "text-[#64748b]", quoteText: "text-[#f8fafc]", quoteUnderline: "bg-[#84cc16]", glow: "bg-[#84cc16]/10",
      }
    : {
        section: "bg-[#F3EFE0]", blob1: "bg-[#DDE9C9]", blob2: "bg-[#CFE1B0]", wave: "text-[#e4dfca]",
        badgeBg: "bg-white/80", badgeText: "text-[#3a3a2c]", badgeBorder: "border-[#e3ddc4]",
        heading: "text-[#1c1c14]", accent: "text-[#2f6b45]", subText: "text-[#5c5a4d]",
        btnPrimary: "bg-[#2f6b45] text-white hover:bg-[#255736]",
        btnOutline: "bg-white text-[#1c1c14] border-[#d9d3ba] hover:bg-[#efe9d6]",
        socialBg: "bg-[#EDE9DA]", socialBorder: "border-[#ddd6bb]", socialText: "text-[#2b2b21]",
        socialHover: "hover:border-[#2f6b45] hover:text-[#2f6b45]", handDrawn: "text-[#2b2b21]",
        arrow: "text-[#8a8570]", quoteText: "text-[#1c1c14]", quoteUnderline: "bg-[#2f6b45]", glow: "bg-[#cfe1b0]/60",
      };

  return (
    <section id="home" className={`relative overflow-hidden pt-32 pb-24 transition-colors duration-500 ${c.section}`}>
      <div className="pointer-events-none absolute inset-0 -z-0">
        ...
        <svg className={`absolute bottom-0 left-0 w-full transition-colors duration-500 ${c.wave}`} viewBox="0 0 1440 220" fill="none" preserveAspectRatio="none">
          <path d="M0 120C240 60 480 180 720 130C960 80 1200 40 1440 100V220H0V120Z" fill="currentColor" />
        </svg>
      </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6 z-10">
            ...
            <div className="flex flex-wrap gap-4 pt-4">
              <a href="#projects" className={`inline-flex items-center justify-center gap-2 px-6 py-2.5 rounded-full font-semibold text-sm transition-all duration-200 hover:scale-[1.02] active:scale-[0.98] ${c.btnPrimary}`}>
                View My Work
                <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24 24"><path stroke="currentColor" strokeWidth={2} d="M14 5l7 7m0 0l-7 7m7-7H3" /></svg>
              </a>
              <a href={personal.resume} target="_blank" rel="noreferrer" className={`inline-flex items-center justify-center gap-2 px-6 py-2.5 rounded-full font-semibold text-sm border transition-all duration-200 hover:scale-[1.02] active:scale-[0.98] ${c.btnOutline}`}>
                Download Resume
                <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24 24"><path stroke="currentColor" strokeWidth={2} d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4" /></svg>
              </a>
            </div>
            ...
            <div className="pt-1">
              <div className="inline-flex flex-col items-start">
                ...
                <div className={`w-full h-0.5 mt-2 rounded-full transition-colors duration-500 ${c.quoteUnderline}`} />
              </div>
            </div>
          ...
          <div className="relative h-[560px] sm:h-[600px] flex justify-center lg:justify-end items-end">
            <div className="absolute top-6 left-0 hidden md:block z-20">
              ...
              <svg className={`w-14 h-14 mt-2 ml-8 transform rotate-12 transition-colors duration-500 ${c.arrow}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="relative w-[380px] h-[480px] z-10">
              ...
              <div className="absolute inset-0 overflow-hidden rounded-[2.5rem]" style={{ maskImage: "linear-gradient(to bottom, black 82%, transparent 100%)", WebkitMaskImage: "linear-gradient(to bottom, black 82%, transparent 100%)" }}>
                <Image src="/profile.jpg" alt={personal.name} fill className="object-cover object-top drop-shadow-2xl" priority />
              </div>
            </div>
          </div>
        </div>
